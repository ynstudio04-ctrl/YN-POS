...
export type Product={id:string;name:string;barcode?:string;sku?:string;category?:string;price:number;priceOptions?:PriceOption[];stock:number;imageUrl?:string;isActive?:boolean};
